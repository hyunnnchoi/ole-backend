...
INSERT INTO LESSON(approved, current_count, description,
                   ...
                   lesson_type, limit_count, place, price, refund, supplies, title, subcategory_id)
VALUES ('APPROVED', 1, '카카오톡의 다양한 기능을 알아보는 과정',
        NOW(), NOW(),
        'MONDAY', NOW(), NOW(), NOW(), NOW(),
        'ONLINE', 30, '노원50플러스센터', 20000, '환불규정', '스마트폰', '카카오톡, 생활에 유용한 앱 활용', 1);
...
VALUES ('REVIEWING', 1, '일반적 표현을 위한 주요 어휘 및 관련 문장 학습',
        ...
        'ONLINE', 30, '동작50플러스센터', 15000, '환불규정', '필기구', 'YOU CAN SPEAK 일상표현 영어', 4);
...
VALUES ('APPROVED', 1, '내 손안에 들어온 작은 컴퓨터_스마트폰을 일상생활에 잘 활용하는 방법',
        ...
        'OFFLINE', 30, '서대문50플러스센터', 0, '환불규정', '스마트폰, 개인 충전기', '생활 스마트폰-처음시작', 1);
